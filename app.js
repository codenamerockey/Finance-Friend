...
var UIController = (function() {
  ...
  var DOMstrings = {
    ...
    let formatNumber = function(num, type) {
        ...
        3. a comma seperating the thousands
        ...
        */  
        ...
        int = numSplit[0];
          if(int.length > 3) {
              int = int.substr(0, int.length - 3) + ',' + int.substr(int.length - 3, 3); // input 2310 -> output 2,310 or 23510 -> 23,510
          }
...
var controller = (function(budgetCtrl, UICtrl){
  ...
  var ctrlAddItem = function() {
    ...
    //if statement for validation of input fields
